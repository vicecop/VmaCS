...
public unsafe struct PositionColorVertex
{
    ...
    public static VertexInputAttributeDescription[] AttributeDescriptions = new VertexInputAttributeDescription[]
    {
        ...
        new(2, 0, Format.R32G32Sfloat, (uint)sizeof(Vector3) * 2)
    };
    ...
    public PositionColorVertex(Vector3 position, Vector3 color, Vector2 uv = default)
    {
        Position = position;
        Color = color;
        Uv = uv;
    ...
    public override bool Equals(object? obj) => obj is PositionColorVertex vert && this == vert;
...
public static class VertexData
{
    ...
    {
        //Face 1
        new(new Vector3(-1, -1, -1), new Vector3(0, 0, 0), new Vector2(0, 0)),
        new(new Vector3(1, -1, -1), new Vector3(1, 0, 0), new Vector2(1, 0)),
        new(new Vector3(-1, 1, -1), new Vector3(0, 1, 0), new Vector2(0, 1)),

        new(new Vector3(-1, 1, -1), new Vector3(0, 1, 0), new Vector2(0, 1)),
        new(new Vector3(1, -1, -1), new Vector3(1, 0, 0), new Vector2(1, 0)),
        new(new Vector3(1, 1, -1), new Vector3(1, 1, 0), new Vector2(1, 1)),

        //Face 2
        new(new Vector3(-1, -1, 1), new Vector3(0, 0, 1), new Vector2(0, 0)),
        new(new Vector3(-1, 1, 1), new Vector3(0, 1, 1), new Vector2(0, 1)),
        new(new Vector3(1, -1, 1), new Vector3(1, 0, 1), new Vector2(1, 0)),

        new(new Vector3(1, -1, 1), new Vector3(1, 0, 1), new Vector2(1, 0)),
        new(new Vector3(-1, 1, 1), new Vector3(0, 1, 1), new Vector2(0, 1)),
        new(new Vector3(1, 1, 1), new Vector3(1, 1, 1), new Vector2(1, 1)),

        //Face 3
        new(new Vector3(1, 1, 1), new Vector3(1, 1, 1), new Vector2(1, 1)),
        new(new Vector3(1, 1, -1), new Vector3(1, 1, 0), new Vector2(1, 0)),
        new(new Vector3(1, -1, 1), new Vector3(1, 0, 1), new Vector2(0, 1)),

        new(new Vector3(1, -1, 1), new Vector3(1, 0, 1), new Vector2(0, 1)),
        new(new Vector3(1, 1, -1), new Vector3(1, 1, 0), new Vector2(1, 0)),
        new(new Vector3(1, -1, -1), new Vector3(1, 0, 0), new Vector2(0, 0)),
        ...
        new(new Vector3(-1, 1, -1), new Vector3(0, 1, 0), new Vector2(1, 1)),
        new(new Vector3(-1, -1, 1), new Vector3(0, 0, 1), new Vector2(0, 0)),
        new(new Vector3(-1, -1, -1), new Vector3(0, 0, 0), new Vector2(1, 0)),
        ...
        new(new Vector3(1, 1, -1), new Vector3(1, 1, 0), new Vector2(1, 0)),
        new(new Vector3(-1, 1, 1), new Vector3(0, 1, 1), new Vector2(0, 1)),
        new(new Vector3(-1, 1, -1), new Vector3(0, 1, 0), new Vector2(0, 0)),
        ...
        new(new Vector3(-1, -1, 1), new Vector3(0, 0, 1), new Vector2(0, 0)),
        new(new Vector3(1, -1, -1), new Vector3(1, 0, 0), new Vector2(1, 1)),
        new(new Vector3(-1, -1, -1), new Vector3(0, 0, 0), new Vector2(0, 1))
    };
    ...
    private static readonly VertexCompareEqual _defaultCompareEqual = (ref PositionColorVertex v0, ref PositionColorVertex v1) => v0.Position == v1.Position && v0.Uv == v1.Uv;
